    ...
    return (
        <div class="row div0">
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div className='me-auto w-100 d-flex justify-content-end position-fixed' class="col-md-2 ">
                        <DropdownButton variant="secondary" class="" title="Latest" id="bg-nested-dropdown">
            ...
            <div class="shadow p-3 mb-5 bg-body rounded div1">
                <div class="row div2">
                    ...
                    <div class="col-md-1">
                        <Button class="btn btn-secondary button" variant="info"><strong>Design</strong></Button>{' '}
                    </div>
                </div>
            ...
            <div class="shadow p-3 mb-5 bg-body rounded div1">
                <div class="row div2">
                    ...
                    <div class="col-md-1">
                        <Button class="btn btn-secondary button" variant="info"><strong>PHP</strong></Button>{' '}
                    </div>
                </div>
            ...
            <div class="shadow p-3 mb-5 bg-body rounded div1">
                <div class="row div2">
                    ...
                    <div class="col-md-1">
                        <Button class="btn btn-secondary button" variant="info"><strong>Django</strong></Button>{' '}
                    </div>
                </div>
            ...
            <div class="shadow p-3 mb-5 bg-body rounded div1">
                <div class="row div2">
                    ...
                    <div class="col-md-1">
                        <Button class="btn btn-secondary button" variant="info"><strong>Testing</strong></Button>{' '}
                    </div>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="shadow p-3 mb-body rounded">
                <Button class="btn btn-secondary text-center" id="div1" variant="info" size="" active>
                    Button
                </Button>
                <br />

                <h4><a href="#">Build Your New Idea with Laravel Freamwork.</a></h4>
            </div>

        </div>

        <div>
            <Button href="#" class="btn btn-secondary" >Previous</Button>{' '} 
